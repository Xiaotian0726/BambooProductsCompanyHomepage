    ...
    <div id="services" className="text-center">
      <div className="container">
        ...
        <div className="row">
          ...
          <div key={`${currentLang.ServiceName1}-0`} className="col-md-4">
            {" "}
          ...
          <div key={`${currentLang.ServiceName2}-1`} className="col-md-4">
            {" "}
          ...
          <div key={`${currentLang.ServiceName3}-2`} className="col-md-4">
            {" "}
          ...
          <div key={`${currentLang.ServiceName4}-3`} className="col-md-4">
            {" "}
