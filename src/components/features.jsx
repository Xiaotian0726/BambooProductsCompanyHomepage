    ...
    <div id="features" className="text-center">
      <div className="container">
        ...
        <div className="row">
          ...
          <div key={`${currentLang.FeatTitle1}-0`} className="col-xs-6 col-md-3">
            {" "}
          ...
          <div key={`${currentLang.FeatTitle2}-1`} className="col-xs-6 col-md-3">
            {" "}
          ...
          <div key={`${currentLang.FeatTitle3}-2`} className="col-xs-6 col-md-3">
            {" "}
